...
// reduce() - не мутирующий метод, возвращает новый массив. Принимает 2 аргумента - стрелочну функцию и начальное значение переменной. ages.reduce((acc, curent) => acc + curent, 0)
...
//* toUppercase()
//* toLowerCase()
//* charAt() - принимает индекс нужного элемента
